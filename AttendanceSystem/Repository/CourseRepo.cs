    ...
    public class CourseRepo
    {
        public string AddCourse(Course newCourse)
        {
            try
            {
                using (var context = new BASContext())
                {
                    ...
                    if (context.SaveChanges() > 0) return "Course added successfully";
        ...
        public string DeleteCourse(int courseId)
        {
            using (var context = new BASContext())
            {
                ...
                if (course != null)
                {
                    ...
                    if (context.SaveChanges() > 0) return "Course deleted successfully";
        ...
        public string UpdateCourse(Course course)
        {
            using (var context = new BASContext())
            {
                ...
                if (context.SaveChanges() > 0) return "Course details updated successfully";
                return "Course details could not be updated";
            }
        }
