    ...
    public class StudentRepo
    {
        public string AddStudent(StudentDetail newStudent)
        {
            try
            {
                using (var context = new BASContext())
                {
                    ...
                    if (context.SaveChanges() > 0) return "Student added successfully";
        ...
        public string DeleteStudent(int studentId)
        {
            using (var context = new BASContext())
            {
                ...
                if (student != null)
                {
                    ...
                    if (context.SaveChanges() > 0) return "Student deleted successfully";
        ...
        public string GraduateStudent(int studentId)
        {
            using (var context = new BASContext())
            {
                ...
                if (student != null)
                {
                    ...
                    if (context.SaveChanges() > 0) return "Student has been marked as graduate successfully";
        ...
        public string UpdateStudent(StudentDetail student)
        {
            using (var context = new BASContext())
            {
                ...
                if (context.SaveChanges() > 0) return "Student details updated successfully";
