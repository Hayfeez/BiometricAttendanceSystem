    ...
    public class StaffRepo
    {
        public string AddStaff(Lecturer newStaff)
        {
            try
            {
                using (var context = new BASContext())
                {
                    ...
                    if (context.SaveChanges() > 0) return "Staff added successfully";
        ...
        public string DeleteStaff(int staffId)
        {
            using (var context = new BASContext())
            {
                ...
                if (staff != null)
                {
                    ...
                    if (context.SaveChanges() > 0) return "Staff deleted successfully";
        ...
        public string UpdateSaff(Lecturer staff)
        {
            using (var context = new BASContext())
            {
                ...
                if (context.SaveChanges() > 0) return "Staff details updated successfully";
